...
- [x] `EXTRACT-TASK-011` (`EXTRACT-Q-007`) Opt-in OpenAI Live Smoke/Evaluation Harness と Honest Partial/Passed Reporting
- [x] `EXTRACT-TASK-012` Documentation、Verification、Traceability、Deviation Audit、Full Quality Gate
