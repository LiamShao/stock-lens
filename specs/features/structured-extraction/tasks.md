...
- [ ] `EXTRACT-TASK-008` (`EXTRACT-FR-007`〜`EXTRACT-FR-010`, `EXTRACT-SEC-001`, `EXTRACT-SEC-006`, `EXTRACT-SEC-008`) Evidence/Compliance Validator と Atomic Finding/Evidence Publish
- [ ] `EXTRACT-TASK-009` (`EXTRACT-FR-001`, `EXTRACT-FR-009`〜`EXTRACT-FR-012`) Durable Metric/Extract/Validate Queue、Retry/Repair、Idempotent Handoff
- [ ] `EXTRACT-TASK-010` (`EXTRACT-AC-001`〜`EXTRACT-AC-014`) Unit、PostgreSQL/Redis/BullMQ Integration、Security、Race Tests
