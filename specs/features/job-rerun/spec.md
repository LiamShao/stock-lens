...
| `RERUN-AC-002` | Given FAILED Parse/Chunk/Metrics/Extract Job、When Re-run、Then Step 固有 Processor へ同じ Durable Target から Dispatch される            |
...
| `RERUN-Q-004` | Manual Re-run の累積 Attempt 上限と対象 Step Allowlist                                                 | Availability / Cost / Abuse Control    | `Resolved: 5; OBJECT_CLEANUP/PARSE/CHUNK/CALCULATE_FINANCIAL_METRICS/EXTRACT` |
